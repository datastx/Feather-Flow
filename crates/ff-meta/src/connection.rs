...
impl MetaDb {
    ...
    pub fn clear_project_data(&self, project_id: i64) -> MetaResult<()> {
        ...
        // Deepest children first, parents last.
        let stmts = [
            ...
            // model_run_config depends on model_run_state
            ...
            // Lineage, diagnostics, schema_mismatches
            ...
            // Tests (reference models and source_tables)
            ...
            // Diagnostics/rule_violations/schema_mismatches referencing compilation_runs
